...
const config = {
  title: 'Health System', //Название сайта на начальной странице
  tagline: 'Туториал', // Описание сайта на начальной странице
  favicon: 'img/favicon.ico', // Иконка сайта
  url: 'https://Emandrr.github.io/', // Адрес gitlab pages, обычно https://<username>.github.io
  baseUrl: 'SA_Hometask', // Базовый url, обычно название репозитория
  organizationName: 'Emandrr', // Имя GitHub пользователя
  projectName: 'SA_Hometask', // Имя репозитория
...
//подключаем плагин для drawio
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: 'docs',
          editUrl:
            'https://github.com/Emandrr/SA_Hometask',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Health System', //Название на навбаре
        logo: {
          alt: 'My Site Logo',
        ...
        items: [
          {
            href: 'https://github.com/Emandrr/SA_Hometask',
            label: 'GitHub',
            position: 'right',
          },
        ],
